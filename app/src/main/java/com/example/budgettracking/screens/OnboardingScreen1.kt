...
val Outfit = FontFamily(
    ...
    Font(R.font.outfitvariable, FontWeight.Normal)
)
...
fun OnboardingScreen1(onNextClick: () -> Unit, onSkipClick: () -> Unit) {
    Box(
        ...
        Column(
            ...
            Text(
                text = "Welcome to SmartBudget, your intelligent finance companion. Get a clear view of your income, spending, and savings all in one smart place.",
